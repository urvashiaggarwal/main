    ...
    for row in records:
        ...
        try:
            ...
            try:
                ...
                driver.execute_script("arguments[0].click();", completion_tab) 
                time.sleep(5)
            except:
            ...
            try:
                print(f"Finding Completion Certificate for {registration_id}")

                # Locate the "Completion Certificate" text
                completion_certificate_text = driver.find_element(By.XPATH, '//*[contains(text(), "Completion Certificate")]')
                driver.execute_script("arguments[0].scrollIntoView();", completion_certificate_text)  # Ensure it's in view
                time.sleep(1)

                # Find the `<a>` link next to the text dynamically
                ...
                driver.execute_script("arguments[0].click();", completion_certificate_link)
                time.sleep(5)
                ...
                if files:
                    ...
                    time.sleep(5)  # Ensure file is fully downloaded before renaming
