...
API_KEYS = ["AIzaSyBogpNygc1Zk4XOX-BYw7ljOyi_T55qU5I",
...
MAX_REQUESTS_PER_MINUTE = 80  # Keep below 100 to avoid bans
REQUEST_DELAY = random.uniform(1.5, 2)  # Delay between requests (1.5 - 2s)
...
print("Results saved to 'squareyards_links.csv'.")
